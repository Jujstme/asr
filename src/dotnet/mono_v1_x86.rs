...
use crate::{Address, Error, Process, Address32};
...
impl<'a> MonoModule<'a> {
    pub fn attach(process: &'a Process) -> Option<Self> {
        let mono_module = process.get_module_address("mono.dll").ok()?;
...
struct MonoInternalHashTable {
    ...
    size: i32,
    num_entries: i32,
    table: MonoPtr32<MonoPtr32<MonoClass>>,
}
...
struct MonoClass {
    ...
    exception_type: u8,
    _padding4: [u8; 3],
    parent: MonoPtr32<MonoClass>, // MonoClass
    ...
    method_first: u32,
    method_count: u32,
    marshal_info: MonoPtr32,  // MonoMarshalType
    fields: MonoPtr32<MonoClassField>,
    methods: MonoPtr32<MonoPtr32>, // MonoMethod
    this_arg: MonoType,
    byval_arg: MonoType,
    generic_class: MonoPtr32,  // MonoGenericClass
    generic_container: MonoPtr32, // MonoGenericContainer
    reflection_info: MonoPtr32,
    gc_descr: MonoPtr32,
    runtime_info: MonoPtr32<MonoClassRuntimeInfo>, // MonoClassRuntimeInfo
    next_class_cache: MonoPtr32<MonoClass>,
    vtable: MonoPtr32<MonoPtr32>, // MonoMethod
    ext: MonoPtr32, // MonoClassExt
    user_data: MonoPtr32,
}
