...
struct MonoInternalHashTable {
    ...
    size: i32,
    num_entries: i32,
    table: MonoPtr64<MonoPtr64<MonoClass>>,
}
...
struct MonoClass {
    ...
    exception_type: u8,
    _padding4: [u8; 3],
    parent: MonoPtr64<MonoClass>, // MonoClass
